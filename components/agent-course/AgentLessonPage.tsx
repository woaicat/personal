...
import AgentSixthLessonPage from "@/components/agent-course/lessons/AgentSixthLessonPage";
import AgentSeventhLessonPage from "@/components/agent-course/lessons/AgentSeventhLessonPage";
import AgentEighthLessonPage from "@/components/agent-course/lessons/AgentEighthLessonPage";
import AgentNinthLessonPage from "@/components/agent-course/lessons/AgentNinthLessonPage";
import AgentTenthLessonPage from "@/components/agent-course/lessons/AgentTenthLessonPage";
import AgentEleventhLessonPage from "@/components/agent-course/lessons/AgentEleventhLessonPage";
...
export default function AgentLessonPage({ lesson }: AgentLessonPageProps) {
  ...
  if (lesson.id === "05") {
    return <AgentFifthLessonPage detail={detail} />;
  }

  if (lesson.id === "06") {
    return <AgentSixthLessonPage detail={detail} />;
  }

  if (lesson.id === "07") {
    return <AgentSeventhLessonPage detail={detail} />;
  }

  if (lesson.id === "08") {
    return <AgentEighthLessonPage detail={detail} />;
  }

  if (lesson.id === "09") {
    return <AgentNinthLessonPage detail={detail} />;
  }

  if (lesson.id === "10") {
    return <AgentTenthLessonPage detail={detail} />;
  }
