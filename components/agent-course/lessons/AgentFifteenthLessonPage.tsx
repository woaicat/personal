...
function ProblemDiagnosis() {
  return <div className={s.visualCard} role="img" aria-label="Agent 退货咨询执行链路与问题定位示意">
    <div className={s.visualHeader}><span className={s.userQuestion}><Bot size={18} aria-hidden="true" />用户：这件商品还能退吗？</span><span className={s.dataNote}>教学示例 · 模拟数据</span></div>
...
function TraceExplorer() {
  ...
  return <div className={s.traceExplorer}>
    <div className={s.traceHeader}><div><h4>退货咨询 · Trace 详情</h4><span>Trace ID: tr_demo_015&nbsp;&nbsp;|&nbsp;&nbsp;总耗时 4.8s</span></div><span className={s.dataNote}>教学示例 · 模拟数据</span></div>
